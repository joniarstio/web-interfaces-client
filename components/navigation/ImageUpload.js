...
export default class ImagePickAndSend extends Component {
  ...
  render() {
    return (
      <View>
        <Text style={{ borderWidth: 1, borderColor: 'black', marginTop: 50}}> Image Picker </Text>

        <TouchableOpacity onPress={this.openImagePickerAsync} style={{ borderWidth: 1, borderColor: 'black', marginTop: 50}}>
